import asyncio
from mautrix.types import Presence
...
class StatusPlugin(Plugin):
    ...
    async def manage_refresher(self):
        ...
        while True:
            await self.client.set_presence(Presence.ONLINE, status=self._current_status)
    ...
    async def cmd_setstatus(self, evt: MessageEvent, status: str):
        ...
        await self.client.set_presence(Presence.ONLINE, status=status)
